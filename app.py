...
def education():
    ...
    # Rennes - Master 2 Biostatistique

    with st.expander("M2 in Clinical Pharmacology, Biostatistics and Epidemiology – Biostatistics track, University of Rennes"):
        display_study(
            "images/rennes_1.png",
            "🎓 M2 in Clinical Pharmacology, Biostatistics and Epidemiology",
            "University of Rennes – Biostatistics track",
            "Sep 2025 - Sep 2026",
            """
            Master's program jointly led by the Université de Rennes and the Université de Nantes,
            in partnership with the universities of Angers, Bretagne Occidentale, Poitiers, and Tours.
            The Biostatistics track trains students in the development and validation of statistical models
            and methods for the analysis and interpretation of complex data in epidemiology and clinical research.
            Key Areas of Study:
            - Longitudinal data analysis and survival analysis
            - Linear and generalized linear models
            - Advanced statistical methods in clinical pharmacology and epidemiology
            - Principles of estimation in biostatistics
            - Etiological research and health measurement scale validation
            - Planning of biomedical research studies
...
def experience():
    ...
    with st.expander("🧬🏥 CHU de Rennes Internship - Bioinformatics / Data Science"):
        display_experience(
            "images/chu_rennes_logo.jpg",
            "CHU de Rennes Internship - Bioinformatics / Data Science",
            "Internship Duration: Mar 2026 - Sep 2026 (6 months)",
            "CHU de Rennes – Laboratoire de bioinformatique médicale, Hôpital Pontchaillou, Rennes · On-site",
            """
            **De l'extraction textuelle à la caractérisation phénotypique : une approche intercentres pour mieux caractériser les maladies rares.**
            * Extraction of phenotypic profiles from free-text medical reports using an AI-based NLP workflow. 
            * Exploratory analysis of phenotypic profile matrices to study the distribution of clinical terms across centers, patients and documents.
            * Manipulation of biomedical ontologies (Human Phenotype Ontology – HPO) for structured phenotype representation.
            * Integration of reference disease phenotypic profiles from Orphanet (Orphapackets) with patient data.
            * Phenotype, disease and gene enrichment analyses using graph-based approaches.
            * Application of in silico methods and machine learning algorithms for rare disease subgroup identification.

            🔬 *Supervised by Axel Bonesteve (Data Scientist) and Dr Marie de Tayrac (PU-PH, Head of Medical Bioinformatics Unit, CHU Rennes).*
            """,
            "Python, R, Bash, Machine Learning, Graph Analysis, Ontologies, Bioinformatics, Data Science",
        )
...
def set_sidbar():
    with st.sidebar:
        ...
        st.title("SUMMARY")
        st.subheader("""
Currently enrolled in the M2 in Clinical Pharmacology, Biostatistics and Epidemiology (Biostatistics track) at the University of Rennes, I am seeking a 4- to 6-month internship starting in early 2026. My background includes a Master’s degree in Digital Sciences and Sport (EUR Digisport), where I specialized in data science. I am now eager to apply my statistical and data skills in healthcare and clinical research, where rigorous, data-driven approaches can generate meaningful contributions to society.
        """)
...
def main():
    ...
    resume_file = current_dir / "pdf" / "CV.pdf"
    ...
    NAME = "Pierre Hernot"
    DESCRIPTION = """
    M2 in Clinical Pharmacology, Biostatistics and Epidemiology | University of Rennes
